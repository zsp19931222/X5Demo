...
/**
 * An alternative Floating Action Button implementation that can be independently placed in one of 8 different places on the screen.
 */
public class FloatingActionButton extends FrameLayout 
{
	 ...
	 * @param layoutParams
	 *            should be either FrameLayout.LayoutParams or WindowManager.LayoutParams
	 */
	public void setPosition(int position, ViewGroup.LayoutParams layoutParams)
	{
		...
		} else
		{
			try
			{
				...
				if (setDefaultMargin)
				{
					int margin = getContext().getResources().getDimensionPixelSize(R.dimen.red_action_button_margin);
					lp.x = margin;
					lp.y = margin;
				}
				setLayoutParams(lp);
	...
	public void setContentView(View contentView, FrameLayout.LayoutParams contentParams)
	{
		...
		if (contentParams == null)
		{
			...
			final int margin = getResources().getDimensionPixelSize(R.dimen.red_action_button_content_margin);
	...
	public static class Builder
	{
		...
		public Builder(Context context)
		{
			...
			int size = context.getResources().getDimensionPixelSize(R.dimen.red_action_button_size);
			int margin = context.getResources().getDimensionPixelSize(R.dimen.red_action_button_margin);
		...
		{
			return new FloatingActionButton(context, layoutParams, theme, backgroundDrawable, position, contentView, contentParams, systemOverlay);
		}
